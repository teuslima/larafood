...
class CreateTenantsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tenants', function (Blueprint $table) {
            ...
            //Status do Tenant (se inativar "N" perde o acesso ao sistema)
            $table->enum('active', ['Y', 'N'])->default('Y');

            $table->date('subscription')->nullable(); // quando se inscreveu
            $table->date('expires_at')->nullable(); // Data que o acesso expira
            $table->string('subscription_id', 255)->nullable(); // identificado do gateway
